...
class Test(unittest.TestCase):
    ...
    def test_sphere_volume(self):
        ...
        # Get the directory of the current script and create file path relative to the script's directory
        script_dir = os.path.dirname(__file__)
        file_path = os.path.join(script_dir, "MA4_1_2.py")

        #file_path = "MA4_files/MA4_1_2.py"  # Replace with your actual file path
